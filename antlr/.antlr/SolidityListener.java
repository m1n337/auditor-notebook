...
public interface SolidityListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SolidityParser#comment}.
	 * @param ctx the parse tree
	 */
	void enterComment(SolidityParser.CommentContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#comment}.
	 * @param ctx the parse tree
	 */
	void exitComment(SolidityParser.CommentContext ctx);
	/**
